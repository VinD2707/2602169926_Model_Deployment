...
model_handler.drop_column()
model_handler.fill_na()
model_handler.encoding()
model_handler.handle_balance_variable()
model_handler.scaling()
model_handler.handle_imbalanced()
model_handler.train_model()
model_handler.makePrediction()
model_handler.evaluate_model()

model_handler.save_model_to_file('2602169926_model_oop.pkl')